...
This folder contains all the charts used in the application. Details about the charts can be found in the
[Charts](/docs/category/charts) section of the documentation under Modules > Charts.
