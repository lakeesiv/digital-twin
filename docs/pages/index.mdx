...
```bash
git clone https://github.com/lakeesiv/digital-twin.git
```

Then copy the ETL folders that you should have into the `servers/sensor` directory. The ETL has
been excluded from the repository
